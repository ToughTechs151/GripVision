...
public class GripPipeline {
	 ...
	 * In inches
	 */
	private static final double LENGTH_OF_OBJECT = 5.0;
...
//	private static final double FOCAL_LENGTH = 788.6;
	 ...
	 */
	private double currentRectWidthPix = 0;
...
//		//Step CV_Resize
//		Mat resizeInput = source0;
//		cvResize(resizeInput, null, 0.875, 0.875, Imgproc.INTER_CUBIC, cvResizeOutput);
		
		// Step HSV_Threshold0:
		Mat hsvThresholdInput = source0;
		double[] hsvThresholdHue = {0.0, 46.38225255972697};
		double[] hsvThresholdSaturation = {0.0, 2.6109215017065024};
		double[] hsvThresholdValue = {245.36870503597123, 255.0};
		hsvThreshold(hsvThresholdInput, hsvThresholdHue, hsvThresholdSaturation, hsvThresholdValue, hsvThresholdOutput);
//		rgbThreshold(hsvThresholdInput, hsvThresholdOutput);
		// Step Blur0:
	...
	private void rgbThreshold(Mat input,
		    Mat out) {
			Imgproc.cvtColor(input, out, Imgproc.COLOR_BGR2RGB);
			Core.inRange(out, new Scalar(210, 220, 215),
				new Scalar(255, 255, 255), out);
		}
	...
	private void boundingRect(Mat source) {
		double greatestArea = 0;
		double length = 0;
		for(MatOfPoint current : filterContoursOutput) {
			...
			if(rect.width*rect.height > greatestArea) {
				greatestArea = rect.width*rect.height;
				length = rect.width;
				currentRectWidthPix = length;
			}
		}
	}
	...
	public double getDistanceAway() {
		return LENGTH_OF_OBJECT*FOCAL_LENGTH/currentRectWidthPix;
	}
